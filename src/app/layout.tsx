...
const socialLinks = [
  { platform: "GitHub", href: "https://github.com/Jeicel", iconPath: "/icons/github_icon.svg" }, // <-- Replace YOUR_GITHUB_LINK and icon path
  { platform: "Gmail", href: "mailto:ortegajeicelmae@gmail.com", iconPath: "/icons/gmail_icon.svg" }, // <-- Replace YOUR_EMAIL_ADDRESS and icon path
];
      ...
      <body
        ...
        <header className="sticky top-0 z-50 flex w-full items-center justify-between px-4 py-2 md:px-8 md:py-3 bg-transparent backdrop-blur-[3px]">
          ...
          {/* Adjusted margin for different screen sizes */}
            <Link href="/" passHref>
             <Image
                src="/logo/Jeicel_logo.png" // Ensure this path is correct and the image is in the public folder
                alt="Jeicel's Logo"
                width={50} // Base size for logo
                height={50} // Base size for logo
