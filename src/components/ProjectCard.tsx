  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between h-full">
        ...
        <motion.div
            className={`relative w-full h-64 flex-grow rounded-xl overflow-hidden z-10 ${imageOrderClass}`} // Added cursor-pointer
        ...
        >
            {/* Use the Image component here - Using fill to cover the container */}
            <Image
